    ...
    def load_param(self, model_path):
        ...
        for k, v in param_dict.items():
            ...
            try:
                ...
                raise RuntimeError('Pretrained parameter mismatch: {}'.format(k)) from exc
        # ImageNet classifier is unused by TransReID; identity heads are new.
        missing = set(self.state_dict()) - loaded - {'fc.weight', 'fc.bias'}
        if missing:
            raise RuntimeError('Missing pretrained parameters: {}'.format(sorted(missing)))
